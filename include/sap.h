...
public: 
    ...
    */
    int SAP(const spinor& v,spinor &x,const int& nu, const int& blocks_per_proc,const bool& print);
...
public:
    ...
    const int& spins, const int& colors) :
    SAP_C(dim1, dim2, tol, Nt, Nx, block_x, block_t,spins,colors) {
    }
